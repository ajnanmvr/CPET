import { faCalendar, faIndianRupee } from "@fortawesome/free-solid-svg-icons";
...
function CourseDetails() {
  ...
  return (
    <article className="px-6 py-24 mx-auto space-y-12 dark:bg-gray-800 dark:text-gray-50">
      <img
        src="/images/dh.jpg"
        className="max-w-3xl mx-auto rounded-[20px]"
        alt=""
      />
      <div className="max-w-2xl mx-auto space-y-4 text-center">
        ...
        <h1 className="text-xl lg:text-3xl text-green-400 font-bold">
          {course?.courseTitle}
        </h1>
      </div>
      <div className="flex justify-around">
        <div className="flex items-center text-xl">
          ...
          <p className="ml-1">{course?.duration}</p>
        </div>
        <div className="flex items-center text-xl">
          <p className="mr-3">Course Fee</p>
          <FontAwesomeIcon icon={faIndianRupee} />
          <p className="ml-1">{course?.amount}</p>
        </div>
      </div>
